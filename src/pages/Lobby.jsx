...
import CameraSelect from '@/components/lobby/CameraSelect';
import MicSelect from '@/components/lobby/MicSelect';
import SpeakerSelect from '@/components/lobby/SpeakerSelect';
import RoomName from '@/components/lobby/RoomName';
import Settings from '@/components/lobby/Settings';
import SdkInfo from '@/components/SdkInfo';
import LocalVideo from '@/components/lobby/LocalVideo';
...
const Lobby = () => {
  ...
  const setConf = useSetRecoilState(Conf);
  ...
  const handleSubmit = async (evt) => {
    ...
    if (
      ...
      serviceInfo.external.serviceId &&
      serviceInfo.external.token
    ) {
